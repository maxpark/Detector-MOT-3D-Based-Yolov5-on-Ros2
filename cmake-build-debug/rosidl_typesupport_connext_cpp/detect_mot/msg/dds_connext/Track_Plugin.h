...
#ifndef Track_Plugin_1143654719_h
#define Track_Plugin_1143654719_h
...
#include "geometry_msgs/msg/dds_connext/Point32_Plugin.h"
...
namespace detect_mot {
    namespace msg {
        namespace dds_ {
            ...
            #define Track_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define Track_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define Track_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define Track_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define Track_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern Track_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            Track_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                Track_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            Track_Plugin_new(void);

            NDDSUSERDllExport extern void
            Track_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* Track_Plugin_1143654719_h */
