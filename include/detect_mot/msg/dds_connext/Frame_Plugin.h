...
#ifndef Frame_Plugin_1720863394_h
#define Frame_Plugin_1720863394_h
...
#include "geometry_msgs/msg/dds_connext/Pose2D_Plugin.h"
...
namespace detect_mot {
    namespace msg {
        namespace dds_ {
            ...
            #define Frame_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define Frame_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define Frame_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define Frame_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define Frame_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern Frame_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            Frame_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                Frame_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            Frame_Plugin_new(void);

            NDDSUSERDllExport extern void
            Frame_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* Frame_Plugin_1720863394_h */
